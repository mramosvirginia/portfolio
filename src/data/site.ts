...
export const lab = {
  en: {
    ...
    aiCode: {
      ...
      intro: 'Real workflows, real bugs, real fixes: how AI tools actually get used in this practice, written up as they happen.',
    ...
    analog: {
      ...
      navBlurb: "Film photography, illustration, motion and other art works. The work that isn't for a client.",
      intro: 'Film photography, illustration, motion and other art works: no case study treatment, just the work.',
  ...
  es: {
    ...
    aiCode: {
      ...
      intro: 'Flujos de trabajo, bugs y soluciones reales: cómo se usan de verdad las herramientas de IA en esta práctica, contado a medida que ocurre.',
    ...
    analog: {
      ...
      navBlurb: 'Fotografía analógica, ilustración, motion y otros proyectos artísticos. El trabajo que no es para un cliente.',
      intro: 'Fotografía analógica, ilustración, motion y otros proyectos artísticos: sin tratamiento de caso de estudio, solo el trabajo.',
